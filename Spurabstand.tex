...
\addtabletext{Die Tabelle stellt die Messergebnisse in Abhängigkeit des Abstands für die CD und DVD da}
\end{table}
...
\sffamily \small{Ein typischer optischer Datenträger mit gekennzeichnetem Radien zur Darstellung des Datenbereichs}
}
\end{figure}
