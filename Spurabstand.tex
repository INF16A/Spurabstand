...
\sffamily \small{Der Winkel \begin{math}\theta\end{math} stellt die Ablenkung des Lichtstrahls gegenüber dem Doppelspalt dar. \begin{math}\Delta s =\end{math} ist der Gangunterschied.}
}
\end{figure}
