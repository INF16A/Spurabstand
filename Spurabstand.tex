...
\usepackage{natbib} %für Harvard Style
\setcitestyle{authoryear,open={(},close={)}}
\let\cite\citep % \let kopiert zweiten Befehl in ersten Befehl

\bibliographystyle{apalike} %Harvard Style, Literaturverzeichnis "`Nachname, V.,"'
